...
g95 -static -ffree-line-length-huge -O2 -fomit-frame-pointer -c shadow_roughness.f90    
...
g95 -static -ffree-line-length-huge -O2 -fomit-frame-pointer -c shadow_pre_sync_urgent.f90
