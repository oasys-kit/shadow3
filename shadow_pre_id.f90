...
SUBROUTINE EPath(i_device)
	...
	!CHARACTER *1024 	RSTRING,OUTFILE,UNOUTFILE,PARFILE,TRAJFILE
	CHARACTER*1024 OUTFILE,UNOUTFILE,PARFILE,TRAJFILE
     	CHARACTER*1024	UNEXAM
...
SUBROUTINE NPhoton
	...
	DIMENSION	DX(N_DIM), DY(N_DIM), DZ(N_DIM)
        ...
        DIMENSION       BX(1001),BY(1001),BZ(1001)
        DIMENSION       ENX(1001),ENY(1001),ENZ(1001)
	!CHARACTER*1024	INFILE,OUTFILE,RSTRING
...
!#endif
	...
	CHARACTER(len=1024) :: FNAME1,FNAME2,SPECFILE
	CHARACTER*60	NAME
	CHARACTER*17	DATE
!C
	DATA		FNAME1	/ '     ' /
