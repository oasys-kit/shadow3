...
!#endif
	...
	character(len=1024) :: inFile1,file_Out,cd
...
SUBROUTINE MirInfo
	...
	type (poolOE)      ::  p1
	character(len=1024) :: mirFil,file_Out,cd
	character(len=80) :: comment,title
...
SUBROUTINE SysInfo
	...
	type (poolOE)      ::  p2
	character(len=1024) :: mirFil,file_Out,cd,optFile
	character(len=80) :: comment,title
	character(len=79),parameter :: topLin= &
'+++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++'
	! for date_and_time
...
!     	CHARACTER * 17		DATETEXT
	...
	character(len=1024),dimension(20)  :: file_In
...
!C
	...
	character(len=1024)  :: fileIn,fileIn2
...
!     	CHARACTER * 80 	FILE_IN
     	character(len=1024) :: FILE_IN, FILE_I0, dataDir
!     	CHARACTER * 60	FILETEXT
!     	CHARACTER * 17	DATETEXT
