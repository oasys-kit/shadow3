...
static PyObject* Source_EnergyRelative(Shadow_Source* self, PyObject* args)
{
  ...
  self->F_COLOR = 4;
  self->N_COLOR = ne;
  if (0<ne){ self->PH1  = e1 ; self->RL1  = r1 ; }
  if (1<ne){ self->PH2  = e2 ; self->RL1  = r2 ; }
  if (2<ne){ self->PH3  = e3 ; self->RL1  = r3 ; }
  if (3<ne){ self->PH4  = e4 ; self->RL1  = r4 ; }
  if (4<ne){ self->PH5  = e5 ; self->RL1  = r5 ; }
  if (5<ne){ self->PH6  = e6 ; self->RL1  = r6 ; }
  if (6<ne){ self->PH7  = e7 ; self->RL1  = r7 ; }
  if (7<ne){ self->PH8  = e8 ; self->RL1  = r8 ; }
  if (8<ne){ self->PH9  = e9 ; self->RL1  = r9 ; }
  if (9<ne){ self->PH10 = e10; self->RL1  = r10; }
  Py_RETURN_NONE;
}
...
{
  if(self->rays!=NULL) Py_DECREF(self->rays);
  self->ob_type->tp_free((PyObject*)self);
}
...
static PyObject* Ray_write(Shadow_Ray* self, PyObject* args)
{
  ...
  nCol = 18;
  CShadowWriteRay(nCol, nPoint, (double*)(self->rays->data), (char*) FileName);
...
static PyObject* Ray_trace(Shadow_Ray* self, PyObject* args)
{
  ...
  if (!PyArg_ParseTuple(args, "O", &pyOe)){
    PyErr_SetString(PyExc_TypeError, "Error passing argument");
    return NULL;
  }
...
{
  if(self->image!=NULL) Py_DECREF(self->image);
  if(self->intensity!=NULL) Py_DECREF(self->intensity);
  self->ob_type->tp_free((PyObject*)self);
}
